...
const Nutritions = lazy(() => import("./pages/Nutritions/Nutritions"));
...
const DirectoryManagement = lazy(
  () => import("./pages/Admin/DirectoryManagement"),
);
        ...
        <main className="flex-grow pt-16">
          <Suspense fallback={<Loader fullScreen />}>
            <Routes>
              ...
              <Route
                path="/courses-workshop/:courseId"
