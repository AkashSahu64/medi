  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Find FNMT (Friends of Naturopathy & Medical Tourism) contacts across different states"
        />
      </Helmet>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-center">
              ...
              <div className="lg:col-span-3">
                ...
                <p className="text-gray-600 text-lg max-w-3xl">
                  Fellowship in Neuro Myoskeletal Techniques (FNMT) contacts
                  across different states. Connect with holistic healthcare
                  facilitators for your wellness journey.
                </p>
              </div>
